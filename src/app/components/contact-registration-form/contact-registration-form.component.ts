...
import { ContactRegistrationService } from '../../services/';
...
export class ContactRegistrationFormComponent implements OnInit {
  ...
  public endpoint = '/ecore/api/v2/core/forms/';
  // public id;
  public settings: any;
  public config: any;
  ...
  public ngOnInit() {
    ...
    this.registerFormId = this.settings.register_form_id || 'ef6a6c38-7169-49ff-8c70-3ca2710049dd';
  ...
  public getRenderData() {
    this.crs.getRenderData(this.registerFormId)
      .subscribe((res) => {
        this.config = res;
