...
import { FallbackDispatcher } from './fallback.dispatcher';
...
export class WebcamComponent implements OnInit, AfterViewInit {
  ...
  public ngOnInit() {
    ...
    if (
      (this.browser.mediaDevices && this.browser.mediaDevices.getUserMedia === undefined) &&
      !!this.browser.getUserMedia_
    ) {
    ...
    // default options
    this.options.fallbackSrc = this.options.fallbackSrc;
  ...
  public addFallbackParams(cam: any): any {
    ...
    paramFlashVars.value =
      'mode=' + this.options.fallbackMode + '&amp;quality=' + this.options.fallbackQuality;
  ...
  public onFallback(): any {
    ...
    if (this.options) {
      ...
      (function register(run) { //tslint:disable-line
