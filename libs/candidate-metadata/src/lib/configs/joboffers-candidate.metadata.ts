      ...
      .setColumns([
        new List.column.element('times', 'Times')
          ...
          .setContent([
            ...
            new List.static.element('shift.time')
              .setLabel('Shift Time')
          ]),
        ...
        new List.column.element('shift.date.job.position', 'Position')
          ...
          .setContent([
            new List.related.element('shift.date.job.position', Endpoints.Skill)
          ]),

        new List.column.element('client', 'Client')
          .setContent([
            new List.related.element('shift.date.job.customer_company', Endpoints.Company),
          ]),
        ...
        new List.column.element('job_site_contact', 'Job Site Contact')
          .setContent([
            new List.related.element('shift.date.job.jobsite.primary_contact', Endpoints.CompanyContact)
          ]),

        new List.column.element('shift.date.job.notes', 'Notes')
          .setSort(true, 'shift.date.job.notes')
          .setContent([
            new List.input.element('shift.date.job.notes')
          ]),
        ...
        new List.column.element('status', 'Status')
          ...
          .setContent([
            ...
            new List.icon.element('status_icon')
              .setValues({ false: 'times', true: 'check', null: 'minus-circle' })
